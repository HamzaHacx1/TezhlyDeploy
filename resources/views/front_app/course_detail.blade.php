                ...
                <div class="col-lg-5 col-12">
                    <div class="pageheader-content">
                        <div class="course-category">
                            <a href="#" class="course-cate">Course Details</a>
                        </div>
                                ...
                                <div class="accordion" id="accordionExample">
                                      ...
                                      <div class="accordion-item">
                                        <div class="accordion-header" id="accordion01">
                                            <button class="d-flex flex-wrap justify-content-between" style="background: #b3b3b3!important;"
                                                data-bs-toggle="collapse" data-bs-target="#videolist1"
                                                aria-expanded="true"
                                                aria-controls="videolist1"><span style="color:black">Lessons</span> <span>
                                                  </span> </button>
                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sidebar-part">
                        <div class="course-side-detail">
                            <div class="csd-title" style="background: #b3b3b3;color:black">
                                <div class="csdt-left">
                                    <h4 class="mb-0" style="color:black"><sup>$</sup>38</h4>
                                </div>
                                <div class="csdt-right">
                                    <p class="mb-0" style="color:black"><i class="icofont-clock-time"></i>Limited time offer</p>
                                </div>
                            </div>
