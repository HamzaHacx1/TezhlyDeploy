...
<style>
    ...
    /* Tasveer ko div ke andar fit karne ke liye */
    .course-thumb img {
        width: 100%;
        height: auto;
        display: block;
...
<div class="group-select-section" style="background: #a0a4a3 !important;">
    <div class="container">
                    ...
                    <div class="course-item">
                        <div class="course-inner">
                            ...
                            <div class="course-content">
                                <div class="course-price" style="background: #cecece;"></div>
                                <div class="course-category">
                                    <div class="course-cate">
                                        <a href="#" style="    background: #fff9f1;">{{$items->category_id}}</a>
                                    </div>
